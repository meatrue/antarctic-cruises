...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_navigation__WEBPACK_IMPORTED_MODULE_2__["initNavigation"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_form__WEBPACK_IMPORTED_MODULE_3__["initForms"])();
...
var toggleError = function toggleError(element, condition) {
  if (condition) {
...
var validateEmailField = function validateEmailField(fieldElement) {
...
var validateNameField = function validateNameField(fieldElement) {
  var fieldValue = fieldElement.value.trim();
  var letters = /^[А-Яа-я\s\-]+$/;
  var condition = fieldValue.match(letters) && fieldValue.length >= 0;
  return toggleError(fieldElement, condition);
};
var validatePhoneField = function validatePhoneField(fieldElement) {
  var phoneMask = /^(8|\+7)(\(?[0-9]{3}\)?)([0-9]{7})$/;
  var condition = fieldElement.value.match(phoneMask);
  return toggleError(fieldElement, condition);
};
var validateAgreementCheckbox = function validateAgreementCheckbox(checkboxElement) {
...
var onFormSubmit = function onFormSubmit(e) {
  e.preventDefault();
  var target = e.target;
  var nameFieldElement = target.querySelector('input[name="name"]');
  var phoneFieldElement = target.querySelector('input[name="phone"]');
  var emailFieldElement = target.querySelector('input[name="email"]');
  var agreementCheckboxElement = target.querySelector('input[name="agreement"]');
  if (validateNameField(nameFieldElement) && validatePhoneField(phoneFieldElement) && validateEmailField(emailFieldElement) && validateAgreementCheckbox(agreementCheckboxElement)) {
    target.submit();
  }
};
var setForm = function setForm(formElement) {
...
var PIN_ICON_PATH = './img/svg/address-marker.svg';
var mapContainerElement = document.querySelector('#map');
var mapImageElement = document.querySelector('#map img');
var setMap = function setMap() {
  if (mapImageElement) {
    mapImageElement.remove();
  }
  var center = [59.938430492248656, 30.32316041534418];
  var myMap = new ymaps.Map(mapContainerElement, {
    // eslint-disable-line
...
var NAV_CONTAINER_ELEMENT_CLASS = 'header';
var NAV_ELEMENT_NOJS_CLASS = 'header--navigation-nojs';
var NAV_TOGGLE_ELEMENT_CLASS = 'header__navigation-toggle';
var NAV_OPENED_CLASS = 'header--navigation-opened';
var NAV_CLOSED_CLASS = 'header--navigation-closed';
var BODY_NAV_OPENED_CLASS = 'navigation-opened';
var NAV_CLASS = 'navigation';
var NAV_LINK_CLASS = 'navigation__link';
var MOBILE_NAV_BREAKPOINT = '767px';
var bodyElement = document.body;
var navigationContainerElement = document.querySelector(".".concat(NAV_CONTAINER_ELEMENT_CLASS));
var navigationToggleElement = document.querySelector(".".concat(NAV_TOGGLE_ELEMENT_CLASS));
var navigationElement = document.querySelector(".".concat(NAV_CLASS));
...
var onNavigationClick = function onNavigationClick(e) {
  var target = e.target;
...
var initNavigation = function initNavigation() {
  var breakpoint = window.matchMedia("(max-width:".concat(MOBILE_NAV_BREAKPOINT, ")"));
