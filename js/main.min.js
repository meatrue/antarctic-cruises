...
var onNavContainerClick = function onNavContainerClick(e) {
  var target = e.target;
  if (target.classList.contains(NAV_LINK_CLASS) || target.classList.contains(NAV_TOGGLE_ELEMENT_CLASS) || target.classList.contains(NAV_CONTAINER_ELEMENT_CLASS)) {
    toggleMenu();
  }
};
